...
*  **1.Input Validation & Sanitization :** Use Use libraries like: `joi`,`express-validator`
It prevents XSS (Cross Site Scripting), SQL/ No-SQL Injection attacks.
...
2. **Using Redis (For distributed rate limiting)**
  * Use this when your app runs on multiple servers or containers (like in production or Kubernetes).
    ...
    ```js
      ...
      app.get("/", (req, res) => {
        res.send("Rate limit test successful ✅");
      });
